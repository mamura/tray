<template>
  ...
  <nav class="absolute top-0 left-0 w-full z-10 bg-transparent flex items-center p-4">
    <div class="w-full mx-auto flex items-center justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
      <!-- Brand -->
      ...
      <form class="md:flex hidden flex-row flex-wrap items-center lg:ml-auto mr-3">
        <div class="relative flex w-full flex-wrap items-stretch">
          ...
          <input
            ...
            class="border-0 px-3 py-3 placeholder-slate-400 text-slate-700 relative bg-white rounded text-sm shadow outline-none focus:outline-none focus:ring w-full pl-10"
          />
        </div>
      </form>
